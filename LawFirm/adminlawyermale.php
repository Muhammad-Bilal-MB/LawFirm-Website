...
<html>
    <head>
        ...
        <link rel="stylesheet" href="adminlawyermale.css">
    </head>
            ...
            <table border="50">
                ...
                <tbody>
                    <?php
                        ...
                        $query=mysqli_query($connection,"select * from Lawyermale");
                        while($row=mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <td><a href="maleedit.php?Id=<?php echo $row['Id']; ?>">Edit</a></td>    
                                <td><a href="maledelete.php?Id=<?php echo $row['Id']; ?>">Delete</a></td>
                            </tr>
                            <?php
                        }
                    ?>
