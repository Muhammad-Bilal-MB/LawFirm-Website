<?php
	...
	$id = $_GET['Id'];
	$query = mysqli_query($connection,"select * from LawyerFemale where Id='$id'");
...
<body>
	<h2>Edit</h2>
	<form method="POST" action="femaleupdate.php?Id=<?php echo $id; ?>" enctype="multipart/form-data">
		...
		<a href="adminlawyerfemale.php">Back</a>
	</form>
</body>
</html>